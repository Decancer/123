...
const PAL_CARDS = [
  {
    ...
    color: "#669988",
    emoji: "💚",
    desc: "瘦瘦高高的青色小家伙，安静地站在最左边。性格沉稳，是队伍里的大哥哥～",
    shape: "42 × 320 · 小圆眼",
  },
  {
    id: "nanami",
    ...
    color: "#EE7744",
    emoji: "🧡",
    desc: "矮矮胖胖的橙色小可爱，眼睛又大又圆。活泼好动，嘴巴还会跟着鼠标跑呢！",
  ...
  },
  {
    ...
    color: "#fef9c3",
    emoji: "💛",
    desc: "比 nanami 高一截的浅黄色伙伴，眼球特别灵活。虽然和 nanami 长得像，但性格更温和～",
  ...
  },
  {
    ...
    color: "#7c3aed",
    emoji: "💜",
    desc: "超宽超矮的紫色大块头，趴在大家后面。存在感十足，是最显眼的背景板！",
