        ...
        <div className="space-y-4">
          {posts.map((post) => (
            <Link
              ...
              className="block rounded-2xl border border-border bg-surface p-5 shadow-card transition-all duration-300 hover:shadow-card-hover hover:border-primary-300 active:scale-[0.98]"
            >
