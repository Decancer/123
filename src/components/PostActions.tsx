      ...
      <div ref={btnRef} className="flex items-center gap-1 ml-3">
        ...
        {isOwn && (
          <button
            ...
            className="rounded-md p-1 text-muted/40 transition hover:bg-primary-50 hover:text-primary-500 dark:hover:bg-[#2a2a45] dark:hover:text-primary-400"
            title="编辑文章"
          >
        ...
        {canDelete && (
          deleteConfirm ? (
            ...
            <button
              ...
              className="rounded-md p-1 text-muted/40 transition hover:bg-primary-50 hover:text-red-500 dark:hover:bg-[#2a2a45] dark:hover:text-red-400"
              title="删除文章"
            >
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
